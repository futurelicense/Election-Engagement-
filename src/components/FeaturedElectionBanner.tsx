...
export function FeaturedElectionBanner() {
  ...
  return (
    <Card className="relative overflow-hidden p-0 mb-8 sm:mb-12 animate-slide-up rounded-2xl border-0 shadow-xl">
      ...
      {/* Live indicator - mobile friendly */}
      <div className="absolute top-3 right-3 sm:top-4 sm:right-4 flex items-center gap-2 glass px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-full">
        <div className="w-2 h-2 rounded-full bg-african-red animate-pulse" />
        <span className="text-[10px] sm:text-xs font-bold text-gray-900 uppercase tracking-wide">
          Live
        </span>
      </div>
      ...
      <div className="relative p-5 sm:p-6 md:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
          <div className="flex items-start gap-4">
            <div className="text-5xl sm:text-6xl shrink-0">{country.flag}</div>
        ...
        <div className="flex justify-center pt-2">
          <Button
            ...
            className="w-full sm:w-auto min-h-[48px] sm:min-h-0 shadow-xl rounded-xl"
          >
