    ...
    <>
      ...
      <div className="min-h-screen w-full bg-gradient-to-b from-white via-gray-50/50 to-gray-100">
        ...
        <div className="relative overflow-hidden border-b border-gray-200/80 bg-white/90 backdrop-blur-sm">
          <div className="absolute inset-0 bg-gradient-to-br from-african-green/5 via-transparent to-african-blue/5 pointer-events-none" />
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6">
            <Button
              variant="ghost"
              size="sm"
              onClick={() => navigate('/')}
              className="mb-4 -ml-1 min-h-[44px] sm:min-h-[40px] text-gray-600 hover:text-gray-900"
            >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-5">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gray-100 flex items-center justify-center text-4xl sm:text-5xl shrink-0">
                  {country.flag}
                </div>
                <div className="min-w-0">
                  <h1 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-gray-900 leading-tight truncate">
                    {country.name}
                  </h1>
                  <p className="text-base sm:text-lg text-gray-600 mt-0.5 line-clamp-2 sm:line-clamp-none">
                ...
                {activeTab === 'share' && (
                  <div className="space-y-6">
                    ...
                    {hasVoted && votedCandidate ? (
                      ...
                      <div className="glass p-6 sm:p-12 rounded-2xl text-center">
                        <ShareIcon className="w-14 h-14 sm:w-16 sm:h-16 text-gray-400 mx-auto mb-4" />
                        ...
                        <Button onClick={() => navigate(`/election/${countryId}`)} className="min-h-[48px] w-full sm:w-auto">
                          Go to Vote
                        </Button>
                      </div>
                    )}
